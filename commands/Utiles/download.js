...
const piecesURL = 'https://raw.githubusercontent.com/GameDevES/Bit/master/commands/Utiles/';
...
module.exports = class extends Command {
	...
	async run(msg, [name, folder]) {
		...
		return descargar(link).then((text) => procesar(this.client, msg, text, link, name)).catch(err => msg.sendMessage(`${msg.author} | ${err}`));
	}

	async procesar(client, msg, text, link, name) {
		try {
