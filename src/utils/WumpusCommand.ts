...
export abstract class BitCommand extends Command {

	public spam: boolean;
	public requiredGuildPermissions: Permissions;

	public constructor(store: CommandStore, file: string[], directory: string, options: BitCommandOptions = {}) {
...
export interface BitCommandOptions extends CommandOptions {
	spam?: boolean;
